...
<link rel="stylesheet" type="text/css" href="../style/basis/install.css">
...
<header id="header">
<h1><?php echo $string['PAGE_TITLE'];?></h1>
</header>
<div id="middle">
...
if (file_exists('BOLT'))
{
 ...
 if (!isset($_GET['page']) or $_GET['page']==1)initialize();elseif($_GET['page']==2)check_con();elseif($_GET['page']==3)installation();
}?>
</section>
</div>
</div>
